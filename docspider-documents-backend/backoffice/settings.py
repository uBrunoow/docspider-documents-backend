...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "backoffice/static/img/admin-site-logo.png",
    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "backoffice/static/img/admin-site-logo.png",
    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": "backoffice/static/img/admin-site-logo-dark.png",
